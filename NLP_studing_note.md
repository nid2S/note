...
- 품사 태깅 : 각 단어의 품사가 명사, 동사, 형용사등 인지 알아냄.
...
##### RNN
- 순환 신경망. 자연어 처리에서 단어의 품사 추축등 여러 분야에서 대표적으로 이용됨. 입력과 출력의 길이를 다르게 셜계할 수 있음. 뉴런단위 보단 입력,출력벡터와 은닉상태(층)라는 표현을 주로 씀. 모든 은닉층의 상태를 출력해 다대다 문제를 해결할 수 있음.
