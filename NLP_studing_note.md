...
- 정제 : 문자가 아닌것을 제외, 소문자화, 불용어 처리, 본문(글자형식)이 아닌것을 제외, 구두점 제거, null 행 제거 등 
...
##### RNN
- 순환 신경망. 자연어 처리에서 단어의 품사 추축등 여러 분야에서 대표적으로 이용됨. 입력과 출력의 길이를 다르게 셜계할 수 있음. 뉴런단위 보단 입력,출력벡터와 은닉상태라는 표현을 주로 씀. 
