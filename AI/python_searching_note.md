# python
***
- python : ±Íµµ ¹Ý ·Î¼¶ÀÌ Á¦ÀÛÇÑ °í±Þ ÇÁ·Î±×·¡¹Ö ¾ð¾î. ºñ¿µ¸®ÀÇ ÆÄÀÌ½ã ¼ÒÇÁÆ®¿þ¾î Àç´ÜÀÌ °ü¸®ÇÏ´Â °³¹æÇü/°øµ¿Ã¼ ±â¹Ý °³¹ß¸ðµ¨À» °¡Áö°í ÀÖÀ½. 
  ±âÁ¸ÀÇ R°ú SAS¸¦ Á¦Ä¡°í µ¥ÀÌÅÍ ºÐ¼®¿¡ °¡Àå ¸¹ÀÌ ¾²ÀÌ°í ÀÖÀ½. ¾ð¾î ÀÚÃ¼°¡ ½±°í, °£°áÇÏ¸ç, Á÷°ü¼ºÀÖ¾î »ç¿ëÇÏ°í ½±°í Á¢±Ù¼ºÀÌ ³ô¾Æ, ´Ù¾çÇÑ °÷¿¡¼­ È°¿ëµÇ°í ÀÖÀ½.
- ¹öÀü : python 3.3ÀÌ»óÀÇ ¹öÀüÀ» ¼³Ä¡ÇÏ¸é windowsÆú´õ¿¡ »ý¼ºµÇ´Â py.exe¸¦ »ç¿ëÇØ, py -¹öÀü À¸·Î ´Ù¾çÇÑ ¹öÀüÀÇ ÆÄÀÌ½ãÀ» »ç¿ëÇÒ ¼ö ÀÖÀ½(3.3ÀÌÇÏµµ °¡´É).
- 2 vs 3 : python2´Â ASCIIÀ¸·Î ±âº» ÀúÀåµÇ°í, Á¤¼öÃ³¸® ±â´ÉÀÌ ¹ÌÈí(5/2==2, 5.0/2.0==2.5)Çß´Ù¸é(+ print "Hello World" ·Î print¹®À» »ç¿ëÇßÀ½), 
  python3´Â Unicode·Î ÀúÀåµÇ°í, Á¤¼öÃ³¸® ±â´ÉÀÌ °³¼±(5/2==2.5)µÇ¾úÀ¸¸ç ¾²·¹±â ¼öÁý ¹× ¸Þ¸ð¸® ÇÒ´ç ±â´ÉÀÌ °³¼±µÇ¾ú°í ±âÁ¸ ¸ñ·ÏÀ» ±â¹ÝÀ¸·Î ¸ñ·ÏÀ» ¸¸µé ¼ö ÀÖ°Ô µÇ¾úÀ½.
- Æ¯Â¡ : ÇÃ·§Æû µ¶¸³Àû, ÀÎÅÍÇÁ¸®ÅÍ½Ä, °´Ã¼ÁöÇâÀû, µ¿ÀûÅ¸ÀÌÇÎ(½ÇÇà½Ã°£¿¡ ÀÚ·áÇüÀ» °Ë»ç)´ëÈ­Çü ¾ð¾î. µé¿©¾²±â¿Í ÄÝ·Ð(:)À¸·Î ÄÚµåºí·ÏÀÌ ±¸ºÐµÇ´Â ¹®¹ýÀ» °¡Áü. µé¿©¾²±â´Â °ø¹é 4¹®ÀÚ¸¦ ±ÇÀåÇÏ¸ç, tabÀº ÀÎÅÍÇÁ¸®ÅÍ°¡ °ø¹é1ÀÚ·Î Ã³¸®ÇÏ±â¿¡ »ç¿ëÇÏ¸é ¾ÈµÇÁö¸¸ ´ëºÎºÐÀÇ ¿¡µðÅÍ¿¡¼­ ÀÚµ¿º¯È¯ ±â´ÉÀ» Á¦°øÇÏ´Ï º° »ó°ü¾øÀ½.
- ¼Óµµ : ÆÄÀÌ½ãÀº ´À¸². ½Ç¹«¿¡¼­´Â ÁÖ·Î ¾²´Â ÇÔ¼ö¸¦ CµîÀ¸·Î ·¡ÇÎÇØ »ç¿ëÇÑ´Ù°í ÇÏ¸ç, °¡Àå ÁÁÀº°Ç ¿ÀÇÂ¼Ò½º¸¦ ¾²´Â °ÍÀÌ¶ó°í ÇÔ. 
  ´À¸° ÀÌÀ¯´Â ¸ÕÀú ÆÄÀÌ½ãÀÌ Á¤ÀûÅ¸ÀÔÀÌ ¾Æ´Ñ µ¿Àû Å¸ÀÔÀÌ¸ç(ÀÛ¾÷ ¼öÇà¿¡ ´õ ¸¹Àº ´Ü°è ÇÊ¿ä)ÀÎÅÍÇÁ¸®ÅÍ ¾ð¾îÀÌ¸ç, °´Ã¼ ¸ðµ¨ÀÌ ºñÈ¿À²Àû ¸Þ¸ð¸® Á¢±Ù(pointer -> pointer_list -> data)À¸·Î ÀÌ¾îÁú ¼ö ÀÖ±â ¶§¹®ÀÓ.
- µ¿ÀÛ°úÁ¤ : ÀÏ¹ÝÀûÀ¸·Î pythonÀº C·Î ±¸ÇöµÇ¾îÀÖ´Âµ¥, ±× ±¸ÇöÃ¼°¡ CPythonÀÓ. ÀÌ CPythonÀº ÀÎÅÍÇÁ¸®ÅÍÀÌ¸ç ÄÄÆÄÀÏ·¯ÀÎµ¥, ÀÛ¼ºÇÑ PythonÄÚµå¸¦ bytecode·Î ÄÄÆÄÀÏÇÏ°í, ±× µÚ interpreter(VM)°¡ ½ÇÇàÇÔ.
  .py ÆÄÀÏÀ» ½ÇÇàÇÏ¸é .pyc¶ó´Â ÆÄÀÏÀÌ »ý¼ºµÇ´Âµ¥, ¾Æ°³ CPythonÀÌ ÄÄÆÄÀÏÇÑ bytecode°¡ µé¾îÀÖ´Â ÆÄÀÏÀÌ¸ç ÀÌ¸¦ interpretÇÏ´Â°Íµµ CPythonÀÓ.
- ÀÌ¿ÜÀÇ ±¸ÇöÃ¼ : Jython(java bytecode·Î ¸¸µå·· JNM¿¡¼­ ½ÇÇàÇÒ ¼ö ÀÖµµ·Ï ÇÔ. .py¸¦ .class·Î ÄÄÆÄÀÏ), PyPy(ÆÄÀÌ½ã ÀÚÃ¼·Î ±¸Çö, JITÄÄÆÄÀÏÀ» µµÀÔÇØ CPythonº¸´Ù ºü¸§), ±× ¿Ü¿¡µµ IronPython, Cython, WinPythonµîÀÌ ÀÖÀ½.
- JIT(just-in-time)ÄÄÆÄÀÏ : ÇÁ·Î±×·¥ ½ÇÇà Àü ÄÄÆÄÀÏÇÏ´Â ´ë½Å ÇÁ·Î±×·¥ ½ÇÇà½ÃÁ¡¿¡¼­ ÇÊ¿ä ºÎºÐÀ» Áï¼®À¸·Î ÄÄÆÄÀÏÇÏ´Â ¹æ½Ä. º¸Åë ÀÎÅÍÇÁ¸®ÅÍ ¾ð¾îÀÇ ¼º´ÉÇâ»óÀ» ¸ñÀûÀ¸·Î µµÀÔÇÏ´Â °æ¿ì°¡ ¸¹À½. 
  ÀÎÅÍÇÁ¸®Æ®°úÁ¤¿¡¼­ ÀÚÁÖ¾²ÀÌ´Â ÄÚµå¸¦ Ä³½ÌÇÏ±â¿¡, ÀÎÅÍÇÁ¸®ÅÍÀÇ ´À¸° ½ÇÇà¼Óµµ¸¦ °³¼±ÇÒ ¼ö ÀÖÀ¸¸ç JVM¿¡¼­µµ ¹ÙÀÌÆ®ÄÚµå¸¦ ±â°è¾î·Î ¹ø¿ªÇÒ ¶§ JITÄÄÆÄÀÏ·¯¸¦ »ç¿ëÇÔ.
- __pycache\_\_ : ÆÄÀÌ½ã ÄÄÆÄÀÏ½Ã »ý¼ºµÇ´Â ¹ÙÀÌÆ®ÄÚµå°¡ ÀúÀåµÇ´Â Æú´õ. ÇØ´ç µ¥ÀÌÅÍ¿¡ ´ëÇÑ ÇâÈÄ ¿äÃ»À» ´õ ºü¸£°Ô Ã³¸®ÇÒ ¼ö ÀÖµµ·Ï µ¥ÀÌÅÍ¸¦ ÀúÀåÇÔ. github °øÀ¯½Ã ¿Ã¶ó°¡Áö ¾Êµµ·Ï ignoreÃ³¸®ÇØÁÖ´Â°Ô ÁÁÀ½.

- º¯¼öÀÇ ÀÚ·áÇü : µ¿ÀûÅ¸ÀÌÇÎ. ±âº»ÀûÀ¸·Î º¯¼öµéÀÌ ¸Þ¸ð¸®¸¦ °øÀ¯ÇÏ±â ¶§¹®¿¡, ÀÚ·áÇüÀ» ¸í½ÃÇÏÁö ¾Ê¾Æµµ ÀÚµ¿À¸·Î ÀÚ·áÇüÀÌ ¸ÂÃçÁø´Ù.
- º¯¼öÀÇ Ç¥±â¹ý : varWithVar ÇüÅÂÀÇ Ä³¸Ö(camel)Ç¥±â¹ý, VarWithVarÇüÅÂÀÇ ÆÄ½ºÄ®(paskal)Ç¥±â¹ý, avar_with_bvarÇüÅÂÀÇ ½º³×ÀÌÅ©(snake)Ç¥±â¹ý µîÀÌ Á¸ÀçÇÔ. 
- ´öÅ¸ÀÌÇÎ : Å¸ÀÔÀ» ¹Ì¸® Á¤ÇÏ´Â°Ô ¾Æ´Ï¶ó ½ÇÇà½Ã ÇØ´ç methodµéÀ» È®ÀÎÇØ Å¸ÀÔÀ» Á¤ÇÔ. µ¿ÀûÅ¸ÀÔ(Å¸ÀÔÁöÁ¤x). 

- ¸í·ÉÇü ÄÚµå : ¹®Á¦ ÇØ°á¿¡ ÇÊ¿äÇÑ ¸ðµç ´Ü°è¸¦ ÀÏÀÏÀÌ Á÷Á¢ ¼±¾ðÇÏ´Â ÄÚµå.
- ¼±¾ðÇü ÄÚµå : ¸í·ÉÇü ÄÚµå¿Í °°Àº ÀÛ¾÷À» ÀÌ¹Ì Á¤ÀÇµÈ ÇÔ¼ö·Î Ã³¸®ÇÔ. ¸í·ÉÇü ÄÚµå À§¿¡ Á¸Àç.
- ÇÔ¼öÇü ÇÁ·Î±×·¡¹Ö : ¼ø¼öÇÔ¼ö(¿ÜºÎ »óÅÂ°ª ÂüÁ¶, ¿ÜºÎ°ª º¯°æ X), ºñ»óÅÂºÒº¯¼º(Àü´ÞµÈ °ªÀ» º¯°æÇÏ´Â°Ô ¾Æ´Ñ, »õ·Î¿î »óÅÂ¸¦ ¸¸µé¾î ¹ÝÈ¯)µîÀÇ Æ¯Â¡À¸·Î ÀÎÇØ sideEffect(ºÎÀÛ¿ë)À» ¹æÁö.
  Expressions Only(if, for, switchµîÀÌ ¾øÀÌ expressionÀ¸·Î¸¸ »ç¿ë), ÇÔ¼ö¸¦ º¯¼ö¿¡ ÇÒ´ç/ÇÔ¼ö¿¡ ÀÎÀÚ·Î Àü´ÞÇÏ°Å³ª ¸®ÅÏ(1±ÞÇÔ¼ö)/ÇÔ¼öÀÚÃ¼¸¦ ÀÎÀÚ·Î Àü´ÞÇÏ°Å³ª ¶Ç´Ù¸¥ ÇÔ¼ö¸¦ ¸®ÅÏÇÏ´Â(°íÂ÷ÇÔ¼ö)¼Ó¼ºÀ» °¡Áö°í ÀÖ¾î¾ß ÇÔ.
- SDK(Software Development Kit) : ÀÏ¹ÝÀûÀ¸·Î ÇÏµå¿þ¾î ÇÃ·§Æû, OS ¶Ç´Â ÇÁ·Î±×·¡¹Ö ¾ð¾î Á¦ÀÛ»ç°¡ Á¦°øÇÏ´Â ÀÏ·ÃÀÇ Åø. ÀÌ¸¦ È°¿ëÇØ Æ¯Á¤ ÇÃ·§Æû, ½Ã½ºÅÛ, ÇÁ·Î±×·¡¹Ö ¾ð¾î¿¡ µû¶ó °³¹ßÀÌ °¡´É. 
  ÄÄÆÄÀÏ·¯, µð¹ö°Å, APIµîÀÌ Æ÷ÇÔµÇ³ª ´Ù¾çÇÑ µµ±¸(¼³¸í¼­, ¶óÀÌºê·¯¸®, ÆíÁý±â, ·±Å¸ÀÓ/°³¹ßÈ¯°æ, Å×½ºÆ®/ºÐ¼® Åø, µå¶óÀÌ¹ö, ³×Æ®¿öÅ© ÇÁ·ÎÅäÄÝ µî)µµ Æ÷ÇÔµÉ ¼ö ÀÖÀ½.

# OOP
- °´Ã¼ÁöÇâÇÁ·Î±×·¡¹Ö(Object Oriented Programming) : ÇÁ·Î±×·¥ ¼³°è¹æ¹ý·ÐÀÌÀÚ °³³äÀÇ ÀÏÁ¾. ÄÚµå¸¦ ÀÛ¼ºÇÏ°í Á¤¸®ÇÏ´Â ¹æ¹ýÀ¸·Î º¼ ¼ö µµ ÀÖÀ¸¸ç ÄÄÇ»ÅÍ ÇÁ·Î±×·¥À» ¸í·É¾îÀÇ ¸ñ·ÏÀ¸·Î º¸´Â ½Ã°¢¿¡¼­ ¹þ¾î³ª ¿©·¯°³ÀÇ µ¶¸³µÈ ´ÜÀ§, Áï "°´Ã¼"µéÀÇ ¸ðÀÓÀ¸·Î ÆÄ¾ÇÇÏ°íÀÚ ÇÏ´Â °Í.
- ÇÙ½É °³³ä : Ä¸½¶È­(Encapsulation), »ó¼Ó(Inheritance), Ãß»óÈ­(Abstraciton), ´ÙÇü¼º(Polymorphism)
- Ä¸½¶È­ : µ¥ÀÌÅÍ, ±×¸®°í µ¥ÀÌÅÍ¸¦ È°¿ëÇÏ´Â ÇÔ¼ö¸¦ Ä¸½¶(ÄÁÅ×ÀÌ³Ê, Å¬·¡½º)¼Ó¿¡ ³Ö¾î³õ´Â °Í. ¼­·Î ¿¬°üµÇ¾îÀÖ´Â µ¥ÀÌÅÍ¿Í ÇÔ¼ö¸¦ ¹­´Â°ÍÀ¸·Î ÄÚµå¸¦ °³¼±(±¸Á¶È­, ÀÎ¼ö X)ÇÒ ¼ö ÀÖÀ½. µ¥ÀÌÅÍ¿Í ÇÔ¼ö¸¦ Á¤¸®ÇÏ´Â ¹æ¹ý·Ð. ¿øÇÏ´Â µ¥ÀÌÅÍ¸¦ ¼û±æ ¼ö ÀÖÀ½.
- »ó¼Ó : ÄÚµå¸¦ ´õ ÀÛÀº ´ÜÀ§·Î ³ª´©°í Àç»ç¿ë ÇÏ°Ô ÇÒ ¼ö ÀÖÀ½. Å¬·¡½º¸¦ È®ÀåÇÏ´Â °ÍÀ¸·Î ºÎ¸ð Å¬·¡½ºÀÇ ¸ðµç ¼Ó¼º°ú ¸Þ¼­µå¸¦ ÀÚ½Ä¿¡°Ô »ó¼ÓÇÔ. ºÐÇÒ ¹× Á¤º¹À» °¡´ÉÇÏ°Ô ÇÔ. 
- Ãß»óÈ­ : ±¸Çö¼¼ºÎÁ¤º¸¸¦ ¼û±â´Â ÀÏ¹Ý ÀÎÅÍÆäÀÌ½º¸¦ ÁöÁ¤ÇÏ´Â ÇàÀ§. ³»ºÎÀÇ µ¿ÀÛ(¼¼ºÎ½ÇÇöÁ¤º¸)À» ¾ËÁö ¸øÇÑÃ¤, Á¦°øÇÏ´Â ÀÎÅÍÆäÀÌ½º¸¸À» »ç¿ëÇØ ±â´ÉÀ» »ç¿ëÇÒ ¼ö ÀÖ°Ô ÇÔ. ³»ºÎ ÀÛ¾÷(¼¼ºÎ±¸ÇöÁ¤º¸)À» ¹Ù²Ù´õ¶óµµ ÀÎÅÍÆäÀÌ½º°¡ ¹Ù²îÁö ¾Ê´Â´Ù¸é ÀÌ¹Ì »ç¿ëÁßÀÎ ÄÚµå¸¦ ¹Ù²Ü ÇÊ¿ä°¡ ¾øÀ½.
- ´ÙÇü¼º : ¸Þ¼­µå ¿À¹ö¶óÀÌµù µîÀ» ÀÌ¿ëÇØ ÇüÅÂ¸¦ º¯°æÇÒ ¼ö ÀÖÁö¸¸, ±âº» °³³ä(¹ÝÈ¯Å¸ÀÔ µî)Àº ÁöÅ´À¸·Î½á Å¬·¡½ºÀÇ ÇÙ½ÉÀº ±×´ë·Î µÎ°í ±¸Çö¹æ½ÄÀÇ ¸ð¾ç°ú ¸ð½ÀÀº ´Þ¶óÁö°Ô ÇÔ.

# operators
- »ê¼ú ¿¬»êÀÚ(Arithmetic Operators) : ´Ü¼ø °è»êÀ» À§ÇÑ ¿¬»êÀÚ. +, -, *, /, %, **, //
- ÇÒ´ç ¿¬»êÀÚ(Assignment Operators) : °ªÀ» º¯¼ö¿¡ ÇÒ´çÇÏ´Â ¿¬»êÀÚ. =, +=, -=, *=, /=, %=. //=, **=
- »ïÇ× ¿¬»êÀÚ(Ternary Operator) : »ïÇ×¿¬»êÀÚ. ½ÇÁ¦·Î ÆÄÀÌ½ã¿¡ »ïÇ×¿¬»êÀÚ´Â ¾øÀ¸³ª, °°Àº ¿ªÇÒÀ» ÇÏ´Â ÆÄÀÌ½ã ¹®¹ý`a if num % 2 ==0 else b`ÀÌ ÀÖÀ½.
- ºñ±³ ¿¬»êÀÚ(Comparison Operators) : ÁÂ¿ì º¯¼ö¸¦ ºñ±³ÇÏ´Â ¿¬»êÀÚ. boolean°ªÀ» ¹ÝÈ¯ÇÔ. ==, !=, >, <, >=, <=
- ³í¸® ¿¬»êÀÚ(Logical Operators) : Á¶°Ç¹® °áÇÕ½Ã »ç¿ëÇÏ´Â ¿¬»êÀÚ. and, or, not
- Ç×µî ¿¬»êÀÚ(Identity Operators) : °°Àº ¸Þ¸ð¸®¿¡ ÀÖ´ÂÁö È®ÀÎÇÏ´Â ¿¬»êÀÚ. is, is not
- ¸â¹ö ¿¬»êÀÚ(Membership Operators) : ¿ÞÂÊ °ªÀÌ ¿À¸¥ÂÊ ÄÁÅ×ÀÌ³Ê °´Ã¼ÀÇ ¸ã¹öÀÎÁö È®ÀÎÇÏ´Â ¿¬»êÀÚ. in, not in 
- ºñÆ® ¿¬»êÀÚ(Bitwise Operators) : ºñÆ®´ÜÀ§·Î ¿¬»êÇÏ´Â ¿¬»êÀÚ. ÃÖ´ëÇÑ ¸Þ¸ð¸®¸¦ ¾Æ³¢±â À§ÇØ »ç¿ë. &, |, ^, ~, <<, >>
- Ãß°¡ : ±× ¿Ü ¿¬»êÀÚ. @(ÇÕ¼º°ö, ndarray³ª tensorµîÀÇ ÀÚ·áÇü°£ÀÇ ÇÕ¼º°öÀ» ÇÏ°Ô ÇÔ), ~(2ÀÇ º¸¼ö ¿¬»êÀÚ, -x - 1)µîÀÌ ÀÖÀ½. 
...
- \' : ÀÛÀºµû¿ÈÇ¥¸¦ Ãâ·ÂÇÔ.
- \" : Å«µû¿ÈÇ¥¸¦ Ãâ·ÂÇÔ.
- \b : ¹é½ºÆäÀÌ½º. ÇÑÄ­ µÚ·Î µ¹¾Æ°¨.
- \n : °³Çà¹®ÀÚ. ÁÙÀ» ¹Ù²Þ(ÇÑÁÙ ¹ØÀ¸·Î °¨).
- \r : Ä³¸®Áö ¸®ÅÏ. ÇöÀç ÇàÀÇ Á¦ÀÏ Ã³À½À¸·Î Ä¿¼­¸¦ ¿Å±è(ÇØ´ç»óÅÂ¿¡¼­ Ãâ·Â½Ã ÇØ´çÁÙÀ» Áö¿ì°í Ãâ·ÂÇÔ).
- \t : ÅÇ. ÅÇÀ» ¶ê(ÁÖ·Î 4Ä­).

# comment
- \# : ÆÄÀÌ½ãÀÇ ÁÖ¼®. ÄÚµå ½ÇÇà½Ã ÀÎ½ÄÇÏÁö ¾ÊÀ½.
- \# TODO : PyCharmÀÇ ÇÒÀÏ °ü¸® ±â´É. ÆÄÀÌÂüÀÇ TODOÇ×¸ñ¿¡¼­ ÇÑ´«¿¡ º¼ ¼ö ÀÖÀ½. todo°¡ ÀÖÀ¸¸é commit½Ã °æ°í°¡ Ãâ·ÂµÊ.
- """ """ : docstring. Å¬·¡½º/¸Þ¼­µå/ÇÔ¼öµîÀÇ »ç¿ëÀÚ°¡ ¾Ë¾Æ¾ß ÇÒ ¼³¸íÀ» Ãß°¡. ÇØ´ç°´Ã¼.__doc\_\_·Î È®ÀÎ°¡´É. ''' '''·Îµµ »ç¿ëÀº °¡´É.
- annotation : Å¬·¡½º/¸Þ¼­µå/ÇÔ¼ö ¿¡¼­ ÀÔ·Â°ª°ú ¹ÝÈ¯°ªÀÇ Á¸Àç/ÀÚ·áÇüÀ» ¾Ë·ÁÁÖ´Â ÁÖ¼®. [ÇÔ¼ö(º¯¼ö: ÀÚ·áÇü) -> ¹ÝÈ¯ÀÚ·áÇü: ÄÚµå] À¸·Î »ç¿ë. ±×³É º¯¼ö¿¡ ÀÚ·áÇüÀ» ÁöÁ¤ÇÒ ¼ö µµ ÀÖÀ½.

# type
- type(º¯¼ö) : º¯¼öÀÇ ÀÚ·áÇü È®ÀÎ °¡´É. ¹ÝÈ¯µÇ´Â ÀÚ·áÇüµéÀº typeÇüÀÓ.
- type(ÀÚ·áÇü()) : ÇØ´ç ÀÚ·áÇüÀÇ type¹ÝÈ¯.
- isinstance(º¯¼ö, ÀÚ·áÇü) : º¯¼ö°¡ ÇØ´ç ÀÚ·áÇüÀÎÁö ¹ÝÈ¯.
...
- sorted(¸®½ºÆ®) = Á¤·ÄµÈ »õ ¸®½ºÆ® »ý¼º. key=lambda item:¼ö½Ä, reverse=bool µîÀ» ÀÎÀÚ·Î ÁÖ¾î Á¤·Ä ±âÁØ, ¹ÝÀü ¿©ºÎ µîÀ» ¼±ÅÃÇÒ ¼ö ÀÖÀ½.
  `sorted(dict.items(), key=operator.itemgetter(0))`Ã³·³ operator¶óÀÌºê·¯¸®ÀÇ itemgetter¸¦ »ç¿ëÇØ [(), ()\]ÇüÅÂÀÇ ¸®½ºÆ®¸¦ Æ¯Á¤ ÀÎµ¦½ºÀÇ °ªÀ» ±âÁØÀ¸·Î Á¤·ÄÇÒ ¼ö ÀÖÀ½.
  keyÀÇ ÇÔ¼öÀÇ ¹ÝÈ¯°ªÀ» ¼ø¼­´ë·Î Á¤·ÄÇÏ´Â Çü½ÄÀÌ¸ç, key¿¡ ÇÔ¼öµéÀ» Æ©ÇÃÇüÅÂ·Î ³ÖÀ¸¸é ´ÙÁß Á¶°ÇÀ¸·Î »ç¿ëÇØ, Ã¹¹øÂ° ÇÔ¼öÀÇ ±âÁØ´ë·Î Á¤·ÄÇÑ µÚ ´ÙÀ½ ÇÔ¼öÀÇ ±âÁØ´ë·Î Á¤·ÄÇÒ ¼ö ÀÖÀ½.
...
## map
***
- map(func, Sequence) ÇüÅÂ·Î »ç¿ë. ½ÃÄö½ºÀÇ °¢ °³Ã¼¿¡ ÇÔ¼ö¸¦ Àû¿ëÇÔ.
- ÀÌÅÍ·¹ÀÌÅÍ °´Ã¼·Î, ÇÑ¹ø °ªÀ» ¹ÝÈ¯ÇÏ¸é ´õ ÀÌ»ó °ªÀ» ¹ÝÈ¯ÇÏÁö ¾ÊÀ½(list(map)Àº ÇÑ¹ø¸¸ »ç¿ëÇÒ ¼ö ÀÖÀ½).
- ÀÔ·Â½Ã¿£ ÁÖ·Î map(int, input().split())½ÄÀ¸·Î ¾²ÀÓ.
...
- any : any(Sequence)·Î »ç¿ëÇÏ¸ç, ½ÃÄö½º ¾È¿¡ True°¡ ÇÏ³ª¶óµµ ÀÖ´Ù¸é True°¡ µÈ´Ù. any(5 < q for q in queue)½ÄÀ¸·Î »ç¿ëÇÒ ¼ö ÀÖÀ½.
- all : all(sequence)·Î »ç¿ëÇÏ¸ç, ½ÃÄö½º ¾È¿¡ False°¡ ÇÏ³ª¶óµµ ÀÖ´Ù¸é False°¡ µÈ´Ù. any(5 < q for q in queue)½ÄÀ¸·Î »ç¿ëÇÒ ¼ö ÀÖÀ½.
...
## file pickle, glob
***
- pickle : ¸Þ¸ð¸®¿¡ ¿Ã¶ó°¡ ÀÖ´Â data ±× ÀÚÃ¼¸¦ dump, load ¸¦ ÅëÇØ ¿ÜºÎ¿¡ ÀúÀåÇÏ°í »ç¿ëÇÏ´Â °Í. .pklÆÄÀÏ Çü½ÄÀ¸·Î ³ªÅ¸³»¾î Áü.
- ÀåÁ¡ : textÆÄÀÏÀ» »ç¿ëÇÏ´Â °æ¿ì ÇÊ¿ä ºÎºÐÀ» ÆÄ½ÌÇØ¾ß ÇÏÁö¸¸, ÀÌ¹Ì ÇÊ¿äÇÑ ÇüÅÂ·Î ÀúÀåµÇ¾îÀÖ¾î ÈÍ¾À ºü¸§.
- ´ÜÁ¡ : À§ÇèÇÔ. ¿ø°ÝÄÚµå½ÇÇà(RCE)°ø°ÝÀ» ¹ÞÀ» ¼ö ÀÖ¾î, »ç¿ë¿¡ ¸Å¿ì ÁÖÀÇÇØ¾ß ÇÔ.
...
- ÀÎ½ºÅÏ½º.¸Þ¼­µå()·Î ÀÎ½ºÅÏ½º ¸Þ¼­µå »ç¿ë. ¸Þ¼­µå ¾È¿¡¼­ Å¬·¡½º ¾ÈÀÇ ´Ù¸¥ ¸Þ¼­µå¸¦ È£ÃâÇÒ ¶§´Â self.¸Þ¼­µå()·Î È£Ãâ.
- ¸ÅÁ÷¸Þ¼­µå(Æ¯º°¸Þ¼­µå) : __·Î ½ÃÀÛÇØ __·Î ³¡³ª´Â ¸Þ¼­µå. Å¬·¡½º ³»¿¡¼­ Æ¯º°ÇÑ ¿ªÇÒÀ» ÇÔ. ´ëÇ¥ÀûÀ¸·Î __init\__(), __next\__()µî.

- isinstance(ÀÎ½ºÅÏ½º,Å¬·¡½º) : ÀÎ½ºÅÏ½º°¡ Å¬·¡½º¿¡ ¼ÓÇØÀÖ´ÂÁö È®ÀÎ. ¸ÂÀ¸¸é True,¾Æ´Ï¸é False ¹ÝÈ¯.
- class attribute : Å¬·¡½º ³»ºÎ(ÇÔ¼öÀÇ ¹Û)¿¡¼­ ¼±¾ðµÇ´Â ¼Ó¼º. ¸ðµç °³Ã¤¿¡¼­ °øÀ¯µÇ¸ç, Å¬·¡½º.¼Ó¼º ¶Ç´Â ÀÎ½ºÅÏ½º.¼Ó¼º À» ÅëÇØ Á¢±Ù°¡´ÉÇÔ.
- instance attribute : self¸Å°³º¯¼ö¸¦ ÅëÇØ Á¤ÀÇµÇ´Â ¼Ó¼º. ÇÑ ÀÎ½ºÅÏ½ºÀÇ °ªÀ» º¯°æÇÏµµ ´Ù¸¥ ÀÎ½ºÅÏ½ºµé´Â ¿µÇâÀÌ ¾øÀ½.
...
- ÀÌÅÍ·¹ÀÌÅÍ´Â Â÷·Ê´ë·Î ¹Ýº¹ÇÏ´Ù ¿¹¿Ü¸¦ ¹ß»ý½ÃÄÑ ¹Ýº¹À» ³¡³½´Ù. list(ÀÌÅÍ·¹ÀÌÅÍ °´Ã¼)·Î ÀÌÅÍ·¹ÀÌÅÍ ³»ÀÇ °ªÀ» ¸ðµÎ º¼ ¼ö ÀÖÀ½.
...
- dis.dis(func) : ÇÔ¼ö°¡ bytecode·Î º¯È¯µÇ´Â °úÁ¤À» º¼ ¼ö ÀÖÀ½. disÆÐÅ°Áö¸¦ import ÇØ¾ß ÇÔ.
...
# other
***
- id(object) : ¿ÀºêÁ§Æ®ÀÇ ÁÖ¼Ò°ª ¹ÝÈ¯.
- eval('¹®ÀÚ¿­') : ¹®ÀÚ¿­ ÇüÅÂÀÇ ÆÄÀÌ½ã ÄÚµå¸¦ ½ÇÇàÇÏ°í °á°ú¸¦ ¹ÝÈ¯
- repr(°´Ã¼) : ÆÄÀÌ½ã ÀÎÅÍÇÁ¸®ÅÍ¿¡¼­ ½ÇÇàÇÒ ¼ö ÀÖ´Â ¹®ÀÚ¿­À» ¹ÝÈ¯
- ord(¹®ÀÚ) : ¹®ÀÚÀÇ ASCII ÄÚµå¸¦ ¹ÝÈ¯
- chr(Á¤¼ö) : ASCIIÄÚµåÀÇ ¹®ÀÚ¸¦ ¹ÝÈ¯
...
- pip.main(["¸í·É¾î", "¸ñÀû¾î"\]) : ÆÄÀÌ½ã ÄÚµå ³»¿¡¼­ pip»ç¿ë.
...
- Math ÆÐÅ°Áö(ÆÄÀÌ½ã ³»Àå) > sqrt(°ª):Á¦°ö±Ù | pow(°ª,Áö¼ö):°ªÀÇ Áö¼öÁ¦°ö ¹ÝÈ¯ | abs(°ª):Àý´ñ°ª ¹ÝÈ¯ | comb(n, k): nCk ¹ÝÈ¯.
...
# timeit
- timeit.timeit(ÇÔ¼ö) : ÇÔ¼öÀÇ ½ÃÀÛºÎÅÍ ³¡±îÁö °É¸° ½Ã°£À» ÃøÁ¤.
- %timeit func : IPython(ÁÖÇÇÅÍ)È¯°æ¿¡¼­ ÇØ´ç ÇÔ¼ö ½ÇÇà½Ã °É¸®´Â ½Ã°£À» ÃøÁ¤. returnÀÌ ÀÖ´Â ÇÔ¼ö³ª lambdaµîÀ¸·Î ÃøÁ¤ÇØ¾ßÇÏ°í, printµîÀ¸·Î ÇÏ¸é ¹«ÇÑ¹Ýº¹ µÈ´Ù.

# Math
- math : ¼öÇÐ ¿¬»ê°ú °ü·ÃµÈ ¸Þ¼­µåµéÀÌ ³»ÀåµÈ ÆÐÅ°Áö.
- math.sqrt(°ª) :Á¦°ö±Ù.
- math.pow(°ª,Áö¼ö) : °ªÀÇ Áö¼öÁ¦°ö ¹ÝÈ¯.
- math.abs(°ª) : Àý´ñ°ª ¹ÝÈ¯.
- math.comb(n, k) : nCk ¹ÝÈ¯.

# tqdm
- tqdm.tqdm(iter) : ÀÌÅÍ·¹ÀÌÅÍ¿¡¼­ °ªÀ» ²¨³»¸ç ÁøÇà·ü Ç¥½ÃÁÙÀ» »ý¼º. desc¸Å°³º¯¼ö·Î ÀÌÅÍ·¹ÀÌ¼Ç¿¡ ´ëÇÑ ¼³¸íÀ» Ãß°¡ÇÒ ½Ã [desc: {i}it \[amount_time, {i/dur}it/s\]]ÀÇ Çü½ÄÀÌ µÊ.
  ÀÌÅÍ·¹ÀÌÅÍ¸¦ °¨½Î for¹® µî .__next\_\_()¸¦ ¼öÇàÇÏ°Ô ÇÏ´Â ½ÄÀ¸·Î »ç¿ëµÊ. `for i in tqdm.tqdm(range(100), desc='test iter')`½Ä.

# itertools
***
- itertools.permutations(list, n) : ¼ø¿­(P, Áßº¹À» Çã¿ëÇÏÁö ¾Ê°í ¼ø¼­°¡ Á¸ÀçÇÏ´Â Ã¤·Î n°³¸¦ »Ì¾Æ¼­ ³ª¿­)À» »ý¼º. ³ª¿Ã ¼ö ÀÖ´Â Á¶ÇÕÈ÷ Â÷·Ê´ë·Î, Æ©ÇÃÇüÅÂ·Î ³ªÅ¸³ª°Ô µÊ.
- itertools.combinations(list, n) : Á¶ÇÕ(C, Áßº¹À» Çã¿ëÇÏÁö ¾Ê°í ¼ø¼­°¡ ¾ø´Â Ã¤·Î n°³¸¦ »Ì¾Æ¼­ ³ª¿­)À» »ý¼º.
- itertools.product(list, n) : Áßº¹¼ø¿­(Pi, Áßº¹À» Çã¿ëÇÏ°í ¼ø¼­°¡ Á¸ÀçÇÏ´Â Ã¤·Î n°³¸¦ »Ì¾Æ¼­ ³ª¿­)À» »ý¼º.
- itertools.combinations_with_replacement(list, n) : Áßº¹Á¶ÇÕ(H, Áßº¹À» Çã¿ëÇÏ°í ¼ø¼­°¡ Á¸ÀçÇÏ´Â Ã¤·Î n°³¸¦ »Ì¾Æ¼­ ³ª¿­)À» »ý¼º.

# collections
***
- collections : Ç¥¿Í ÀÎµ¦½Ìµî µ¥ÀÌÅÍ¸¦ ´Ù·ê¶§ Æ¯È÷ À¯¿ëÇÑ ¶óÀÌºê·¯¸® ¸ðµâ. µ¥ÀÌÅÍÃ³¸®¸¦ À§ÇÑ À¯¿ëÇÑ °´Ã¼°¡ ¸¹ÀÌ ÀÖÀ½. dict()ÀÇ ±âº» API»ç¿ë°¡´É.
- collections.namedtuple('ÀÚ·áÇüÀÌ¸§', ['¿ä¼ÒÀÌ¸§1', '¿ä¼ÒÀÌ¸§2'\]) : °¢ ¿ä¼Ò¿¡ ÀÌ¸§À» ÁöÁ¤ÇØÁÖ´Â namedtuple »ý¼º.
...
# logging
- logging : ¼ÒÇÁÆ®¿þ¾î°¡ ÀÛµ¿ ÁßÀÏ¶§ ¹ß»ýÇÏ´Â ¿©·¯ »ç°ÇÀ» ÃßÀûÇÏ´Â ÆÄÀÌ½ã ³»Àå ¶óÀÌºê·¯¸®. ¸Þ¼¼ÁöÀÇ Çü½Ä°ú ³»¿ëÀ» ¸ðµÎ Á¦¾îÇÒ ¼ö ÀÖÀ½. °¢ »ç°ÇÀÇ Áß¿äµµ¸¦ levelÀÌ¶ó°í Á¤ÀÇÇÏ°í ÀÖÀ½.
- level : DEBUG -> INFO -> WARNING -> ERROR -> CRITICAL 
  - DEBUG : °£´ÜÈ÷ ¹®Á¦¸¦ Áø´ÜÇÏ°í ½ÍÀ» ¶§ ÇÊ¿äÇÑ ÀÚ¼¼ÇÑ Á¤º¸¸¦ ±â·ÏÇÔ.
  - INFO : °èÈ¹´ë·Î ÀÛµ¿ÇÏ°í ÀÖÀ½À» ¾Ë¸®´Â È®ÀÎ ¸Þ½ÃÁö, print¿Í °°Àº ´À³¦À¸·Î »ç¿ëµÊ.
  - WARNING : ¼ÒÇÁÆ®¿þ¾î°¡ ÀÛµ¿Àº ÇÏ°í ÀÖÁö¸¸, ¿¹»óÄ¡ ¸øÇÑ ÀÏÀÌ ¹ß»ýÇß°Å³ª ÇÒ °ÍÀ¸·Î ¿¹ÃøµÈ´Ù´Â °ÍÀ» ¾Ë¸². ±âº»¼³Á¤.
  - ERROR : Áß´ëÇÑ ¹®Á¦·Î ÀÎÇØ ¼ÒÇÁÆ®¿þ¾î°¡ ¸î¸î ±â´ÉµéÀ» ¼öÇàÇÏÁö ¸øÇÔÀ» ¾Ë¸². 
  - CRITICAL : ÀÛµ¿ÀÌ ºÒ°¡´ÉÇÑ ¼öÁØÀÇ ½É°¢ÇÑ ¿¡·¯°¡ ¹ß»ýÇÔÀ» ¾Ë¸².
- Áß¿ä±¸¼º¿ä¼Ò : logger, handler, filter, formatter. Log»ç°ÇÁ¤º¸µéÀº LogRecord Instance¾È¿¡ ÀÖ´Â À§ ¿ä¼Òµé »çÀÌ¿¡¼­ Àü¼Û. formatter(format)¿Í handlersµîÀÇ ¼³Á¤Àº jsonÆÄÀÏ·Î ¸¸µé¾î °ü¸®ÇÏ¸é ÁÁÀ½.
  - Logger : Logger Å¬·¡½ºÀÇ ÀÎ½ºÅÏ½º. loggingÀÇ ½ÃÀÛ. °¢ logger´Â nameÀ» °®°ÔµÇ°í, ¿¤¸®¸àÆ® Çü½ÄÀ¸·Î(.À» ÅëÇØ)°èÃþÀû °ü°è¸¦ Çü¼ºÇÏ°Ô µÇ¸ç ¼³Á¤À» º¯È­½ÃÅ°Áö ¾ÊÀ¸¸é ÀÚ½ÄÀÌ ºÎ¸ðÀÇ ¿©·¯ Æ¯¼ºÀ» ¹°·Á¹Þ°Ô µÊ.
  - Handler : log±â·ÏµéÀÌ Ç¥½Ã/±â·ÏµÉ Àå¼Ò¸¦ °áÁ¤. log¸Þ¼¼ÁöÀÇ level¿¡ µû¶ó ÁöÁ¤µÈ À§Ä¡¿¡ Àü´ÞÇÏ´Â ¿ªÇÒÀ» ¼öÇà. ±â´É°ú ¸ñÀû¿¡ µû¶ó ¿©·¯°³¸¦ °¡Áú ¼ö ÀÖÀ¸¸ç, °¢ handler´Â ´Ù¸¥ level°ú formatÀ» °¡Áú ¼ö µµ ÀÖÀ½.
  - Filter : °£´ÜÈ÷ »ç¿ëÇÒ ¶§´Â Àß ¾²ÀÌÁö´Â ¾ÊÀ¸³ª levelº¸´Ù º¹ÀâÇÑ ÇÊÅÍ¸µÀ» ¿øÇÒ¶§(¾î¶² log±â·ÏÀÌ Ãâ·ÂµÉÁö Á¤ÇÒ¶§)»ç¿ëµÊ. 
  - formatter : ½ÇÁ¦ Ãâ·ÂÇü½ÄÀ» °áÁ¤ÇÔ.

- logger = logging.getLogger(name) : logging ÀÎ½ºÅÏ½ºÀÎ logger »ý¼º. ¾Æ¹«°Íµµ ÀÔ·ÂÇÏÁö ¾ÊÀ¸¸é root logger°¡ »ý¼ºµÊ.
- logger.setLevel(level) : logger¿¡ level ºÎ¿©. ÁöÁ¤ÇÑ levelÀÌ»óÀÇ ¸Þ¼¼Áö¸¦ Ãâ·ÂÇÒ ¼ö ÀÖ°Ô µÊ. logging.Level·Î level°´Ã¼¸¦ ²¨³¾ ¼ö ÀÖÀ½.
- logger.addHandler(ÇÚµé·¯) : ·Î°Å¿¡ ÇÚµé·¯ ¼³Á¤. ÇÚµé·¯´Â ±â´É°ú ¸ñÀû¿¡ µû¶ó ¿©·¯°³ ÀÏ ¼ö ÀÖÀ¸¸ç, °¢ ÇÚµé·¯´Â ´Ù¸¥ level°ú formatÀ» °¡Áú ¼ö ÀÖÀ½.
- logger.info(Message) : info ¸Þ¼¼Áö¸¦ ÄÜ¼Ö¿¡ Ãâ·Â. ÀÌ¿Ü¿¡µµ °¢ levelÀ» ¼Ò¹®ÀÚ·Î ¹Ù²ã ¸Þ¼­µå·Î »ç¿ëÇÏ¸é ÇØ´ç levelÀÇ ¸Þ¼¼Áö¸¦ Ãâ·ÂÇÒ ¼ö ÀÖÀ½.
- logger.exception(Message) : ¿¡·¯¸Þ¼¼Áö¸¦ ¼³Á¤.
- logger.propagate = False : ÀÚ½ÄÀ¸·ÎÀÇ ÀüÆÄ(¿¬°á)À» ÇÏÁö ¾Ê°Ô ÇÔ.

- logging.StreamHandler() : stream(console)¿¡ ±â·ÏÇÏ´Â ½ºÆ®¸² ÇÚµé·¯ °´Ã¼¸¦ »ý¼º.
- logging.FileHandler(file_name) : ÆÄÀÏ¿¡ ±â·ÏÇÏ´Â ÆÄÀÏ ÇÚµé·¯ °´Ã¼¸¦ »ý¼º.
- handler.setLevle(·¹º§) : ÇÚµé·¯¿¡ ·¹º§ ¼³Á¤.
- handler.setFormatter(formatter) : formatter ¼³Á¤.

- logging.Formatter(fmt, datefmt, style) : ¸Þ¼¼ÁöÀÇ Ãâ·ÂÇü½ÄÀ» °áÁ¤ÇÏ´Â Formatter»ý¼º. °¢ log±â·ÏµéÀº LogRecord°´Ã¼ÀÇ ¼Ó¼ºÀ¸·Î Á¤ÀÇµÇ¾î ÀÖÀ¸¸ç(asctime-ÀÎ°£ÀÌ ÀÐÀ» ¼ö ÀÖ´Â ½Ã°£ µî)formatÁ¤ÀÇ¿¡ È°¿ëµÊ(ÀÚ¼¼ÇÑ°Ç °ø½Ä¹®¼­).
  fmt(¸Þ¼¼Áö Ãâ·Â ÇüÅÂ, NoneÀÌ¸é raw), datefmt(³¯Â¥, NoneÀÌ¸é '%Y-%m-%d %H:%M:%S'), style([%, {, $]Áß ÇÏ³ª. fmtÀÇ ½ºÅ¸ÀÏÀ» °áÁ¤)ÀÇ ÀÎÀÚ¸¦ »ç¿ëÇÒ ¼ö ÀÖÀ½. 
...
- add_argumentÀÎÀÚ : action(ÀÎÀÚ¹ß°ß½Ã ¼öÇàÇÒ ¾×¼ÇÀÇ ±âº»Çü), nargs(¼ÒºñµÇ¾ßÇÏ´Â ÀÎÀÚÀÇ ¼ö), const(ÀÏºÎaction¹×nargs¼±ÅÃ½Ã ÇÊ¿ä»ó¼ý°ª), dest(args.dest·Î »ç¿ëµÉ python³»ºÎ¿¡¼­ÀÇ ÀÎÀÚÀÌ¸§),
  default(ÀÎÀÚ°¡ ¸í·ÉÇà¿¡µµ namespace¿¡µµ ¾øÀ¸¸é »ý¼ºµÇ´Â °ª), type(¸í·ÉÇàÀÎÀÚ°¡ º¯È¯µÇ¾ß ÇÒ Çü), choices(ÀÎÀÚ·Î Çã¿ëµÇ´Â °ªÀÇ ÄÁÅ×ÀÌ³Ê),
  required(¸í·ÉÇà ¿É¼Ç »ý·«°¡´É¿©ºÎ), help(ÀÎÀÚ±â´É¿¡ ´ëÇÑ °£´ÜÇÑ ¼³¸í), metavar(»ç¿ë¸Þ¼¼Áö¿¡ »ç¿ëµÇ´Â ÀÎÀÚ¸í), dest(parse_args()ÀÇ ¹ÝÈ¯°´Ã¼¿¡ Ãß°¡µÉ ¼Ó¼ºÀÌ¸§).
- add_argument¿¹½Ã : [parser.add_argument('-b', '--batch-size', type=int, default=8, metavar='N', help='input batch size for training (default: 8)')]
...
# warnings
- warnings : °æ°í ¸Þ¼¼Áö¿Í °ü·ÃµÈ Á¶ÀÛÀ» ÇÒ ¼ö ÀÖ´Â ¶óÀÌºê·¯¸®.
- warnings.warn(message) : °æ°í¸Þ¼¼Áö Ãâ·Â.
- warnings.filterwarnings(action='ignore') : °æ°í¸Þ¼¼Áö ¹«½Ã(²ô±â)
- warnings.filterwarnings(action='default') : °æ°í¸Þ½ÃÁö ÀçÃâ·Â.
- warnings.filterwarnings(action='error') : °æ°í¸Þ½ÃÁö¸¦ ¿¡·¯·Î ¹Ù²Þ.
- warnings.filterwarnings(action='once') : °æ°í¸Þ½ÃÁö¸¦ À§Ä¡¿Í °ü°è¾øÀÌ ÇÑ¹ø¸¸ Ãâ·Â.
...
# sys
- sys : ÆÄÀÌ½ã ÀÎÅÍÇÁ¸®ÅÍ¸¦ Á¦¾îÇÒ ¼ö ÀÖÀ½.
- sys.argv : ¸í·ÉÇà¿¡¼­ Àü´ÞÇÑ ÀÎÀÚ¸¦ ¹ÞÀ» ¼ö ÀÖÀ½. python¸í·É¾î µÚÀÇ ¸ðµç°ÍµéÀÌ °ø¹éÀ» ±âÁØÀ¸·Î ³ª´µ¾î ¸®½ºÆ®ÀÇ ¿ä¼Ò°¡ µÊ(Ã¹ ¿ä¼Ò´Â ÆÄÀÏ¸í).
- sys.exit() : °­Á¦·Î ½ºÅ©¸³Æ® Á¾·á. Ctrl+Z/Dµî°ú °°Àº ±â´ÉÀ» ÇÔ.
- sys.stdin : ¹ÞÀº ÀÔ·Â(ÀüÃ¼)À» ¹ÝÈ¯ÇÔ. ¶óÀÎº°·Î ¸®½ºÆ®·Î ÀúÀåµÇ¾îÀÖÀ½. ¿©·¯ÁÙÀÇ ÀÔ·ÂÀ» ÇÑ¹ø¿¡ ¹ÞÀ» ¼ö ÀÖ´Â ¹æ¹ý.
- sys.path : ÆÄÀÌ½ã ¸ðµâµéÀÌ ÀúÀåµÇ¾îÀÖ´Â À§Ä¡µéÀ» ¹ÝÈ¯ÇÔ. ''Àº ÇöÀç µð·ºÅä¸®. .append()·Î °æ·Î¸¦ Ãß°¡ÇÏ¸é ÇØ´ç °æ·ÎÀÇ ÆÄÀÌ½ã¸ðµâÀ» »ç¿ëÇÒ ¼ö ÀÖÀ½.
- sys.ps1 : ÇöÀç ÇÁ·ÒÇÁÆ®(ÄÚµå ÀÔ·ÂÀ» ÀÇ¹ÌÇÏ´Â >>>)¸¦ ¹ÝÈ¯. ÀÌ º¯¼ö¿¡ °ªÀ» ÇÒ´çÇØ ´Ù¸¥°É·Î ¹Ù²Ü ¼ö ÀÖÀ½.
...
# os | os(ÆÄÀÏ, µð·ºÅä¸®)°ü·Ã ¸í·É
- os.getcwd() : ÇöÀç ÀÛ¾÷ Æú´õ ¹ÝÈ¯.
- os.chdir(°æ·Î) : µð·ºÅä¸® º¯°æ.
- os.makedirs(dir¸í) : µð·ºÅä¸® »ý¼º.  
- os.listdir(°æ·Î) : °æ·Î ¾ÈÀÇ ÆÄÀÏ ÀÌ¸§À» ÀüºÎ ¹ÝÈ¯.
- os.getenv(È¯°æº¯¼ö ¸í) : È¯°æº¯¼ö¸¦ ¾ò¾î¿È.
- os.cpu_count() : ÄÄÇ»ÅÍÀÇ cpu°³¼ö¸¦ ¹ÝÈ¯.

- os.environ[] : È¯°æº¯¼ö ¼³Á¤¿¡ »ç¿ë. key¿¡ È¯°æº¯¼ö ÀÌ¸§À» ¼³Á¤ÇÑ µÚ ¹®ÀÚ¿­·Î ÇØ´ç È¯°æº¯¼ö¿¡ µé¾î°¥ °ªÀ» ÇÒ´çÇÏ¸é µÊ.
- os.environ.get(È¯°æº¯¼ö ¸í) : È¯°æº¯¼ö¸¦ ¾òÀ½.

- os.path.abspath(»ó´ë °æ·Î) : Àý´ë °æ·Î ¹ÝÈ¯. 
- os.path.dirname(°æ·Î) : µð·ºÅä¸®¸í¸¸ ¹ÝÈ¯.
- os.path.basename(°æ·Î) : ÆÄÀÏ ÀÌ¸§¸¸ ¹ÝÈ¯.
- os.path.join(»óÀ§, ÇÏÀ§) : °æ·Î¸¦ º´ÇÕÇØ »õ °æ·Î »ý¼º. ('C:\Tmp', 'a', 'b')½ÄÀ¸·Î ³Ö´Â´Ù.
- os.path.isdir(°æ·Î) : Æú´õÀÇ Á¸Àç ¿©ºÎ¸¦ ¹ÝÈ¯.
- os.path.isfile(°æ·Î) : ÆÄÀÏÀÇ Á¸Àç ¿©ºÎ¸¦ ¹ÝÈ¯.
- os.path.exists(°æ·Î) : ÆÄÀÏ È¤Àº µð·ºÅä¸®ÀÇ Á¸Àç ¿©ºÎ¸¦ ¹ÝÈ¯.
- os.path.getsize(°æ·Î) : ÆÄÀÏÀÇ Å©±â ¹ÝÈ¯.

# tkinter
- tkinter : ÆÄÀÌ½ã GUIÇÁ·Î±×·¡¹Ö ÆÐÅ°Áö. ÆÄÀÌ½ã¿¡¼­ ±âº» Á¦°ø. ±¸±ÛÀÇ colabÀÌ³ª ¼­¹öÄÄÇ»ÅÍ¸¦ ÀÌ¿ëÇÑ ½ÇÇà µî, ¼­¹ö¸¦ µû·Î µÎ°íÀÖ´Â È¯°æ¿¡¼± ½ÇÇàÇÒ ¼ö ¾ø´Ù.
### À©µµ¿ì
- win = tkinter.Tk() : tkÀÎÅÍ °´Ã¼ »ý¼º. Ã¢¿¡ ´ëÇÑ Á¶ÀÛÀÌ ÀÌ °´Ã¼¸¦ ÅëÇØ ÀÌ·ïÁü.
- win.mainloop() : Ã¢ ½ÇÇà. Ã¢¿¡ ´ëÇÑ ¸ðµç Á¶ÀÛ/¼³Á¤ÀÌ ÀÌ·ïÁø ÈÄ¿¡ »ç¿ë. ½ÇÇà½Ã Ã¢ÀÇ Á¾·á½Ã±îÁö ´õÀÌ»ó ÄÚµå°¡ ÁøÇàµÇÁö ¾ÊÀ½.
- win.geometry("X(³Êºñ)xY(³ôÀÌ)") : Ã¢ Å©±â Á¶Àý. (³Êºñx³ôÀÌ+xÁÂÇ¥+yÁÂÇ¥)½ÄÀ¸·Î »ç¿ë.
- win.title(str) : Ã¢ Á¦¸ñ ¼³Á¤.
- win.option_add("*Font", "¸¼Àº°íµñ(Á¾·ù) 25(Å©±â)") : ÆùÆ®ÀÇ Á¾·ù/Å©±â ¼³Á¤. tkÀÎÅÍÀÇ ±âº» ÆùÆ®°¡ ÀÛ¾Æ »ç¿ëÇØÁÖ¾î¾ß ÇÔ. 
- win.configure(bg="»ö") : Ã¢ ¹è°æ»ö ¼³Á¤.
- win.after(Áö¿¬½Ã°£(ms), ½ÇÇàÇÔ¼ö, ÇÔ¼öÀü´ÞÀÎÀÚ1, 2) : ÀÏÁ¤½Ã°£ ÈÄ ÇÔ¼ö ½ÇÇà.
- win.after_cancle(afterº¯¼ö) : after»èÁ¦. after¸¦ ÀÌ¿ëÇÑ Àç±Í¸¦ ¸¸µç ÈÄ Àç±Í¸¦ Å»Ãâ/»èÁ¦½Ã À¯¿ë.
### À§Á¬
- À§Á¬.config() : À§Á¬¿¡ ¼³Á¤À» Àû¿ë. °¢ À§Á¬ÀÇ »ý¼º½Ã ³ÖÀ» ¼ö ÀÖ´Â ÀÎÀÚ´Â ÀüºÎ ³ÖÀ» ¼ö ÀÖÀ½. °¢ À§Á¬ÀÇ ÀÎÀÚ´Â control+Å¬¸¯À¸·Î initÀ» ¿­¾îº¸¸é º¼ ¼ö ÀÖÀ½.
- À§Á¬.pack() : ¼³Á¤ÇÑ À§Á¬À» packÇü½Ä(½×À½)À¸·Î Àû¿ë(¹èÄ¡). side=top/left/right/bottomÀ¸·Î À§Ä¡¸¦, padx/y=i·Î ÆÐµùÀ» ¼³Á¤ÇÒ ¼ö ÀÖÀ½.
- À§Á¬.grid() : À§Á¬À» gridÇü½Ä(°ÝÀÚ)À¸·Î Àû¿ë(¹èÄ¡). column=i, row=j·Î À§Ä¡¸¦, row/columnspan=nÀ¸·Î °ø°£ º´ÇÕÀ» »ç¿ëÇÒ ¼ö ÀÖÀ½. À§Á¬ÀÇ »çÀÌ°¡ ºô ¼ö ¾øÀ½.
- À§Á¬.place() : À§Á¬À» placeÇü½Ä(ÀÚÀ¯)À¸·Î Àû¿ë(¹èÄ¡). x=x,y=y·Î Àý´ëÀû À§Ä¡¸¦, relx/y·Î »ó´ëÀû À§Ä¡¸¦ ÁöÁ¤ °¡´É.
##### button
- btn = tkinter.Button(win) : win¿¡ ¹öÆ° »ý¼º. text="¹öÆ°"µîÀÇ ÀÎÀÚ¸¦ ÁÖ¾î ¹öÆ°¿¡ ´ëÇÑ ¼³Á¤ÀÌ °¡´É.
- btn.config(command=ÇÔ¼ö) : ¹öÆ° Å¬¸¯½Ã ÇÔ¼ö¸¦ Àû¿ë.  
##### entry
- ent = tkinter.Entry(win) : win¿¡ ÀÔ·ÂÃ¢ »ý¼º.
- ent.get() : ÀÔ·ÂÃ¢¿¡¼­ ÀÔ·ÂµÈ ¹®ÀÚ¿­À» °¡Á®¿È.
- ent.config(show="*") : ÀÔ·Â ¹®ÀÚ¸¦ ¼û±è(ÀÔ·ÂµÈ ¹®ÀÚ·Î ´ëÃ¼).  
- ent.insert(i, ¹®ÀÚ¿­) : iºÎÅÍ ¹®ÀÚ¿­À» »ðÀÔ.
- ent.delete(i, j) : i~(j-1)±îÁöÀÇ ¹®ÀÚ¿­À» »èÁ¦. 
- ent.bind(¹öÆ°¸í, ÇÔ¼ö) : ÀÔ·ÂÃ¢À» ¹öÆ°À¸·Î Å¬¸¯ÇßÀ» ¶§ ÇÔ¼ö¸¦ ½ÇÇà. ¹öÆ°Àº"<Button-1>"(¿ìÅ¬¸¯)½ÄÀÌ¸ç, ÇÔ¼ö´Â eventÀÎÀÚ¸¦ ¹Þ¾Æ¾ß ÇÔ.
##### label
- lab = tkinter.Label(win) : win¿¡ ¶óº§À» »ý¼º. text, image(PhotoImage°´Ã¼)µîÀÇ ÀÎÀÚ¸¦ »ç¿ë °¡´É. 
- img = tkinter.PhotoImage(file="°æ·Î", master=win) : ÀÌ¹ÌÁö°´Ã¼ »ý¼º.
- img.subsample(i) : i¹è·Î ÀÌ¹ÌÁö¸¦ Ãà¼Ò.
##### listbox
- lb = tkinter.Listbox(win) : ¸®½ºÆ®¹Ú½º »ý¼º. ½ºÅÃÃ³·³ ¼±ÅÃÁö°¡ ¹Ú½ºÇüÅÂ·Î ÆîÃÄÁ® ÀÖÀ½.
- lb.insert(i, ¹®ÀÚ¿­) : i¿¡ ¹®ÀÚ¿­À» »ðÀÔ.
- lb.curselection() : ¼±ÅÃÇÑ Ç×¸ñÀÇ ÀÎµ¦½º¸¦ Æ©ÇÃÇüÅÂ·Î ¹ÞÀ½.
- lb.config(selectmode="multiple") : ¿©·¯°³¸¦ ¼±ÅÃÇÒ ¼ö ÀÖµµ·Ï ÇÔ.
##### check/radio button
- iv = tkinter.intVar() : µé¾î°£ À§Á¬ÀÇ »óÅÂ¿¡ µû¶ó »óÅÂ°¡ ¹Ù²î´Â º¯¼ö »ý¼º. .get()À¸·Î Ã¼Å©¿©ºÎ(0,1)¸¦ ¹Þ¾Æº¼ ¼ö ÀÖÀ½.
- cb = tkinter.Checkbutton(win, variable=iv) : Ã¼Å©¹Ú½º »ý¼º. Ã¼Å© »óÅÂ¿¡ µû¶ó iv.get()ÀÇ °ªÀÌ ¹Ù²î¸ç, ¼±ÅÃÁö¸¶´Ù À§Á¬À» Ãß°¡ÇØ¾ßÇÔ.
- rb = tkinter.Radiobutton(win, value=°ª, variable=iv) : ¶óµð¿À¹öÆ° »ý¼º. iv.get()»ç¿ë½Ã Ã¼Å©µÈ ¶óµð¿À¹öÆ°ÀÇ value°ªÀÌ ¹ÝÈ¯µÊ. 
##### combo box
- cb = tkinter.ttk.Combobox(win, values=¸®½ºÆ®) : ÄÞº¸¹Ú½º »ý¼º. ¸®½ºÆ® ¼Ó °ªÀ» ÄÞº¸¹Ú½ºÀÇ °ªµé·Î ÇÔ. 
- cb.get() : ¼±ÅÃµÈ °ªÀ» ¹ÝÈ¯.
##### spinbox
- sb = tkinter.Spinbox(win, from_=min, to=max) : ½ºÇÉ¹Ú½º »ý¼º. min¿¡¼­ max±îÁö ¼öÄ¡¸¦ Á¶Àý °¡´É.
- sb.get() : ¼±ÅÃµÈ °ªÀ» ¹ÝÈ¯.
##### scale
- sc = tkinter.Scale(win) : ½ºÄÉÀÏ¹Ù(¼Ò¸®Á¶Àýµî¿¡ »ç¿ëµÇ´Â ¸·´ë)»ý¼º. lengthÀÎÀÚ·Î ±æÀÌ Á¶Àý °¡´É.
- sc.config(from_=min, to=max) : ½ºÄÉÀÏ¹Ú½ºÀÇ ¹üÀ§ ¼³Á¤.
- sc.config(orient="horizontal") : ½ºÄÉÀÏ¹Ú½ºÀÇ ¹æÇâÀ» °¡·Î·Î º¯°æ.
- sc.config(tickinterval=i) : ½ºÄÉÀÏ¹Ú½º¿¡ Ç¥½ÃµÇ´Â ¼ýÀÚÀÇ °£°ÝÀ» i·Î º¯°æ.

# pygame
- pygame : pythonÀ» ÅëÇØ °ÔÀÓÀ» ¸¸µé ¼ö ÀÖµµ·Ï Áö¿øÇØÁÖ´Â ¸ðµâ. [import->init(ÃÊ±âÈ­)->Àü¿ªº¯¼ö¼±¾ð->ÀÌº¥Æ®/È­¸é/»ç¿ëÀÚ ÇàÀ§ ¼³Á¤(¹Ýº¹¹®)]ÀÇ ±¸Á¶·Î ÀÌ·ïÁü.
- pygame.init() : ¸ðµâ ÃÊ±âÈ­. pygame¸ðµâ »ç¿ë½Ã ÇÊ¼ö·Î ÇØÁà¾ß ÇÔ. 
- pygame.display.set_caption() : Ã¢ÀÌ ÄÑÁú¶§ Ã¢ÀÇ ÀÌ¸§À» ¼³Á¤.
- pygame.display.set_mode([x, y\]) : pygameÀ¸·Î »ý¼ºÇÒ GUIÃ¢ÀÇ Å©±â¸¦ ¼³Á¤ ÈÄ È­¸éÀ» ¼³Á¤ÇÏ±â À§ÇÑ °´Ã¼ »ý¼º. .fill((r,g,b))À¸·Î ¹è°æ»öÀ» ¼³Á¤ÇÏ´Â µîÀÇ Á¶ÀÛÀÌ °¡´É.
- pygame.time.Clock() : È­¸éÀ» ÃÊ´ç ¸î¹ø Ãâ·ÂÇÏ´ÂÁö(FPS)¼³Á¤ÇÏ±âÀ§ÇÑ Clock°´Ã¼ »ý¼º. .tick(i)·Î FPS¼³Á¤ °¡´É.
- pygame.event.get() : °ÔÀÓÁß°£¿¡ ¹ß»ýÇÑ ÀÌº¥Æ®¸¦ Ä³Ä¡. [event.type == pygame.QUIT]À¸·Î Ã¢¿¡¼­ x¹öÆ°ÀÌ ´­·È´ÂÁö µîÀÇ ÀÌº¥Æ®¸¦ °Ë»çÇÒ ¼ö ÀÖÀ½.
- pygame.display.filp() : drawÇÔ¼ö³ª screen(set_mode())·Î È­¸é¿¡ ÀÛ¼ºÇÑ ¸ðµç°ÍÀ» ¾÷µ¥ÀÌÆ®. 

- pygame.draw.rect/polygon/circle/eclipse/arc/line/lines/aaline/aalines() : µµÇü/¼±À» ±×¸². ¿©·¯ ¸Å°³º¯¼ö¸¦ ÁÖ¾î µµÇüÀÇ »ö/Å©±â/À§Ä¡/±× ¿Ü ±âÅ¸µîµîÀ» ¼³Á¤°¡´É.
...
- git commit --amend : Ä¿¹Ô¸Þ¼¼Áö¸¦ ¼öÁ¤ÇÔ.

- git clone (±êÇãºê µð·ºÅä¸® ÁÖ¼Ò) .(ÇöÀç µð·ºÅä¸®) : github µð·ºÅä¸®ÀÇ ÆÄÀÏÀ» ÀüºÎ º¹»çÇØ¿È
- git log : »ý¼ºÇÑ ¹öÀüÀ» º¸¿©ÁÜ.
- git diff : ¸¶Áö¸· ¼öÁ¤ ÀÌÈÄ Ãß°¡ÇÑ ³»¿ëÀ» ¾Ë·ÁÁÜ

- git status : »óÅÂ(¼öÁ¤ÇÑ ºÎºÐ/stage¿¡ ¿Ã¶óÀÖ´Â ÆÄÀÏ)¸¦ º¸¿©ÁÖ°í, ÇöÀç À§Ä¡ÇÑ branch¸¦ È®ÀÎÇÒ ¼ö ÀÖÀ½.
- git push : ÄÄÇ»ÅÍ¿¡ ÀúÀåµÈ gitÆÄÀÏÀ» ±êÇãºê¿¡ µî·Ï. remote·Î ¼³Á¤ÇÑ ¿ø°Ý ÀúÀå¼Ò¿¡ push.
- git push remote¸í(origin) branch¸í(master) : remote¿¡ branch¸¦ push. Ä¿¹Ô¹øÈ£:branch¸í À¸·Î Æ¯Á¤ Ä¿¹Ô±îÁö¸¸ push ÇÒ ¼ö µµ ÀÖÀ½.
- git pull : ¿ø°ÝÀúÀå¼Ò·ÎºÎÅÍ ÇÊ¿äÇÑ ÆÄÀÏÀ» ´Ù¿î+º´ÇÕ. Áö¿ª ºê·£Ä¡¿Í ¿ø°ÝÀúÀå¼Ò origin/master°¡ °°Àº À§Ä¡¸¦ °¡¸®Å´.
- git fetch : ¿ø°ÝÀúÀå¼Ò·ÎºÎÅÍ ÇÊ¿äÇÑ ÆÄÀÏÀ» ´Ù¿î. Áö¿ªºê·£Ä¡´Â Áö¿ªÀúÀå¼ÒÀÇ ÃÖ±Ù Ä¿¹ÔÀ», ¿ø°ÝÀúÀå¼Ò´Â °¡Á®¿Â ÃÖ½Å Ä¿¹ÔÀ» °¡¸®Å´.

- git branch ºê·£Ä¡¸í : »õ ºê·£Ä¡ »ý¼º.
- git branch -d ºê·£Ä¡¸í : ÇØ´ç ºê·£Ä¡ »èÁ¦. 
- git checkout ºê·£Ä¡¸í : ÇØ´ç ºê·£Ä¡·Î º¯°æÇÔ.
- git merge ºê·£Ä¡¸í : ÇØ´ç ºê·£Ä¡¸¦ ÇöÀç ºê·£Ä¡·Î º´ÇÕÇÔ. ÇöÀç ºê·£Ä¡¿¡¼­ ÇØ´ç ºê·£Ä¡·Î ¹éÆ®·¡Å· ¾øÀÌ °¥ ¼ö ÀÖ´Ù¸é »¡¸®°¨±âº´ÇÕÀ», ¾Æ´Ï¸é 3¹æÇâ º´ÁuÀ» ½ÇÇàÇÏ¸ç, --no--ff¿É¼ÇÀ» »ç¿ëÇÏ¸é Ç×»ó »õ Ä¿¹ÔÀ» ¸¸µé°Ô ÇÒ ¼ö ÀÖÀ½.
- git reset HEAD [file¸í] : addµÇ¾î stage¿¡ ¿Ã¶ó°¡ÀÖ´Â ÆÄÀÏÀ» UnstageÇÔ(add¸¦ Ãë¼ÒÇÔ). file¸íÀ» »ý·«ÇÏ¸é ¸ðµç ÆÄÀÏÀÌ Ãë¼ÒµÊ.
- git reset HEAD^ : ÃÖ±ÙÀÇ commitÀ» Ãë¼ÒÇÏ°í ÇØ´ç ÆÄÀÏÀ» Unstaged»óÅÂ·Î º¸Á¸ÇÔ. --mixed ¿É¼ÇÀ» »ç¿ëÇÑ°Í°ú °°À¸¸ç, --soft´Â staged»óÅÂ·Î º¸Á¸, --hard¸¦ »ç¿ëÇÏ¸é unstaged»óÅÂ·Î »èÁ¦µÊ.
- git reset HEAD~i : ÃÖ±Ù i°³ÀÇ commitÀ» Ãë¼ÒÇÔ.
...
- ÀÛµ¿ÇÏÁö ¾ÊÀ» ¶§ : gitÀÇ Ä³½Ã°¡ ¹®Á¦°¡ µÇ´Â °ÍÀÌ´Ï, `git rm -r --cached .` -> `git add .` -> `git commit -m "fixed untracked files"`À» ÇØÁÖ¸é µÊ.
...
- [java -jar (bfgÆÄÀÏ°æ·Î+bfgÆÄÀÏ¸í).jar --delete-files(-D) (»èÁ¦ÇÒÆÄÀÏ)] : »èÁ¦ ÆÄÀÏ µî·Ï. ÆÄÀÏ »èÁ¦. °æ·Î´Â ÀÌ·±½Ä(D:\Git\bfg-1.14.0.jar).
- [git reflog expire --expire=now --all && git gc --prune=now --aggressive] : ÆÄÀÏ »èÁ¦ È®Á¤. ÀÌ ÀÌÈÄ push¸¦ ½ÇÇàÇÏ¸é µÊ. 

- README.md : °¢ ·¹Æ÷ÁöÅä¸® ÃÖ»ó´Ü(.gitignore¿Í °°Àº À§Ä¡)¿¡ README.md¶ó´Â ÆÄÀÏÀÌ ÀÖÀ¸¸é ÇØ´ç ÆÄÀÏÀÌ README·Î ±êÇãºê¿¡ Ç¥½ÃµÇ°í, 
  À¯Àú¸í/À¯Àú¸í ·¹Æ÷ÁöÅä¸®¿¡ README.md¸¦ ³Ö¾î ±êÇãºêÀÇ ÇÁ·ÎÇÊÀ» ²Ù¹Ð ¼ö ÀÖÀ½.  

# scp/ssh
- (º¹»çÇÒ ÆÄÀÏÀÇ °æ·Î¿¡¼­) scp file.txt(ÆÄÀÏ¸í) temp_1@10.120.72.239:/home/temp_1(ÆÄÀÏÀ» º¹»çÇØ ³ÖÀ» °æ·Î) : ÆÄÀÏÀ» º¹»çÇØ ³ÖÀ½.
- ssh ip : ÇØ´ç ip·Î Á¢¼Ó. -p ÀÎÀÚ·Î Æ÷Æ®¸¦ ÁöÁ¤ÇÏ°Å³ª ÇÒ ¼ö ÀÖÀ½. usage -> `ssh temp_1@10.120.72.237 -p 22` 

# linux
- rm -r dir1/ : dir1µð·ºÅä¸® »èÁ¦. ÆÄÀÏÀÌ µé¾îÀÖ´Â µð·ºÅä¸®µµ »èÁ¦ÇÔ. -rf ·Î »ç¿ëÇÏ°Ô µÇ¸é °­Á¦·Î, -ri·Î »ç¿ëÇÏ°Ô µÇ¸é ÇÏ³ªÇÏ³ª È®ÀÎÇÏ¸ç »èÁ¦ÇÏ°Ô µÊ.
- dir : ÇöÀç µð·ºÅä¸®ÀÇ ÆÄÀÏ, Æú´õ È®ÀÎ.
- mkdir µð·ºÅä¸®¸í : µð·ºÅä¸® »ý¼º. 
- ll : µð·ºÅä¸® ³»ºÎÀÇ ÆÄÀÏÀ» ÀÚ¼¼È÷ Ç¥½Ã. ls -l °ú µ¿ÀÏÇÔ.
- ls : µð·ºÅä¸® ³»ºÎÀÇ ÆÄÀÏ¸ñ·Ï Ç¥½Ã.
- mv ÀÌµ¿ÆÄÀÏ ÀÌµ¿À§Ä¡ : ÆÄÀÏÀ» ÀÌµ¿.
- cp º¹»çÆÄÀÏ º¹»çÀ§Ä¡ : ÆÄÀÏÀ» º¹»ç.
- zip ¾ÐÃàÆÄÀÏ¸í.zip ÆÄÀÏ/µð·ºÅä¸® : ÆÄÀÏ/µð·ºÅä¸® zipÀ¸·Î ¾ÐÃà
- unzip ÆÄÀÏ : zip ÆÄÀÏ ¾ÐÃàÇØÁ¦
- cd °æ·Î : °æ·Î·Î ÀÌµ¿.
- pwd : ÇöÀç °æ·Î È®ÀÎ.
- export : ÀüÃ¼ È¯°æº¯¼ö È®ÀÎ. export È¯°æº¯¼ö=»õ °ª À¸·Î È¯°æº¯¼öÀÇ º¯°æÀÌ °¡´ÉÇÔ. echo È¯°æº¯¼ö ·Î Æ¯Á¤ È¯°æº¯¼öÀÇ °ª¸¸ º¼ ¼ö µµ ÀÖÀ½.

- vi ÆÄÀÏ¸í : ÆÄÀÏ¸íÀÌ Á¸ÀçÇÑ´Ù¸é ÇØ´ç ÆÄÀÏÀ», ¾Æ´Ï¸é »õ ÆÄÀÏÀ» vi ÆíÁý±â·Î ¿ÀÇÂ. ´Ù¾çÇÑ ¸í·É¾î°¡ Á¸ÀçÇÔ.
- nvidia-smi : ÇöÀç GPU»ç¿ë·®À» º¸¿©ÁÜ.
- Ctrl + Insert / Ctrl + shift + C : º¹»ç -> Ctrl + C·Î Å¬¸³º¸µå¿¡ º¹»ç
- Shift + Insert / Ctrl + shift + V : ºÙ¿©³Ö±â -> ¿ìÅ¬¸¯À¸·Î ºÙ¿©³Ö±â
